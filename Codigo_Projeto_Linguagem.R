...
dados <- read_excel("C:/FCD/ProjetosFer/2 - Prevendo Eficiência de Extintores de Incêndio/dataset original/Acoustic_Extinguisher_Fire_Dataset.xlsx")
View(dados)
...
# Converter Variavel para factor
...
'Embora o desbalanceamento entre as classes seja leve, optamos por não aplicar técnicas de balanceamento neste momento.
No entanto, o balanceamento será reavaliado em etapas posteriores, caso o desnível entre as classes se torne mais acentuado.'
